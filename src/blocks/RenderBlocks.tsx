...
import { BoxScene } from './ThreeBlock/Component'
import { SuzumeScene } from './Suzume/Component'
...
const blockComponents = {
  ...
  'box-scene': BoxScene,
  'suzume-scene': SuzumeScene,
  hero3d: Hero3DRenderer,
  gap: GapComp,
  featureImages: FeatureComp,
  scrollDetail: ScrollDetailComp,
}
